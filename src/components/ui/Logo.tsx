...
export default function Logo() {
	...
	const [animateForward, setAnimateForward] = createSignal(true);
	const [animateBackward, setAnimateBackward] = createSignal(false);
	const [animateHide, setAnimateHide] = createSignal(false);
	...
	return (
		<svg
			classList={{
				[styles.logo]: true,
				[styles["animate-forward"]]: animateForward(),
				[styles["animate-backward"]]: animateBackward(),
				[styles["animate-hide"]]: animateHide(),
			}}
		...
		>
			<For each={["-shadow", ""]}>
				{styleSuffix => (
					<path
						classList={{
							[styles["m" + styleSuffix]]: true,
							[styles["path" + styleSuffix]]: true,
						}}
			...
			<For each={["-shadow", ""]}>
				{styleSuffix => (
					<path
						classList={{
							[styles["i-line" + styleSuffix]]: true,
							[styles["path" + styleSuffix]]: true,
						}}
